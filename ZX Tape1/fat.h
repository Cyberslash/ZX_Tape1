...
const char Text_FAT_Type[] PROGMEM =  "File system \0";
const char Text_FAT32[] PROGMEM =     "FAT32- Error!  \0";
const char Text_FAT16[] PROGMEM =     "FAT16- Ok.      \0";
const char Text_FAT12[] PROGMEM =     "FAT12- Error!  \0";
